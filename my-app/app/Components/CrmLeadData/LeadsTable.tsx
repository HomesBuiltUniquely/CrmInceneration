...
function LeadRow({ row }: { row: LeadRowModel }) {
  ...
  return (
    <div
      ...
      className="grid cursor-pointer grid-cols-12 items-center gap-3 border-t border-[var(--crm-border)] px-6 py-4 transition-colors hover:bg-[var(--crm-surface-subtle)]"
      role="button"
      tabIndex={0}
      onKeyDown={(event) => {
    ...
    >
      <div className="col-span-3 flex items-center gap-3">
        <div className="h-9 w-9 rounded-full bg-[var(--crm-border)]" />
      ...
      <div className="col-span-0 flex justify-end">
        {row.actionIcon === "alert" ? (
          ...
          <button
            ...
            className="rounded-xl p-2 hover:bg-[var(--crm-surface-subtle)]"
          >
            <BoltIcon />
          </button>
        )}

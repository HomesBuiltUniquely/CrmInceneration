...
export default function TeamIncentivesOverview({ members, selectedId, onSelect }: Props) {
      ...
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div>
          ...
          <p className="mt-1 text-[12px] text-[var(--inc-muted)]">
            Select a team member to view their full incentive breakdown.
          </p>
        </div>
        ...
        <table className="w-full min-w-[760px] text-left text-[13px]">
          <thead>
            <tr className="border-b border-[var(--inc-border)] text-[10px] font-bold uppercase tracking-wide text-[var(--inc-muted)]">
              ...
              <th className="pb-3 pr-4">Speed Bonus</th>
            ...
            {rows.map(({ member, profile }) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3 pr-4">{profile.summary.onSpotBonus}</td>
                  <td className="py-3">
                    <button
                      type="button"
